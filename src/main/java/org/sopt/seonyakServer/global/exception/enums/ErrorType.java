...
public enum ErrorType {
    ...
    INVALID_CERTIFICATION_CODE_ERROR(HttpStatus.BAD_REQUEST, "40012", "인증번호가 올바르지 않습니다."),
    NO_CERTIFICATION_REQUEST_HISTORY(HttpStatus.BAD_REQUEST, "40013", "인증 요청 이력이 존재하지 않습니다."),
